...
const int TOKENS_TO_READ = 100000;
const int COSINE_DISTANCE = 0;
const int EUCLEDEAN_DISTANCE = 1;
...
const int NUM_THREADS = std::thread::hardware_concurrency(); // Use the number of available cores
